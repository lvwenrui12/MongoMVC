...
namespace Mitsubishi.FX.FxProgramProtocol
{
    public class FxAddressManager
    {
        ...
        private void LoadDefault()
        {
            ...
            {
                { FxAddressLayoutType.AddressLayoutBin, new FxAddressLayoutInfo(GetLayoutInfo_BinLayout()) },
                { FxAddressLayoutType.AddressLayoutByte, new FxAddressLayoutInfo(GetLayoutInfo_ByteLayout()) },
                { FxAddressLayoutType.AddressLayoutInt16, new FxAddressLayoutInfo(GetLayoutInfo_Int16Layout()) },
                { FxAddressLayoutType.AddressLayoutInt32, new FxAddressLayoutInfo(GetLayoutInfo_Int32Layout()) }
            };
        ...
        private Dictionary<FxAddressType, uint> GetLayoutInfo_BinLayout()
        {
            ...
            {
                { FxAddressType.X, 0x0080 },
                { FxAddressType.Y, 0x00A0 },
                { FxAddressType.M, 0x0100 },
                { FxAddressType.S, 0x0000 },
                { FxAddressType.T, 0x00C0 },
                { FxAddressType.C, 0x01C0 },
                { FxAddressType.D, 0x1000 }
            };
            return (lst);
        }
        ...
        private Dictionary<FxAddressType, uint> GetLayoutInfo_ByteLayout()
        {
            Dictionary<FxAddressType, uint> lst = new Dictionary<FxAddressType, uint>
            {
                { FxAddressType.X, 0x0400 },
                { FxAddressType.Y, 0x0500 },
                { FxAddressType.M, 0x0800 },
                { FxAddressType.S, 0 },
                { FxAddressType.T, 0x0600 },
                { FxAddressType.C, 0x0E00 },
                { FxAddressType.D, 0x1000 }
            };
            return (lst);
        }
