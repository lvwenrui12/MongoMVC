...
namespace Mitsubishi.FX.SerialDevice
{
    /// <summary>
    /// 串行口管理类
    /// 
    ...
    public sealed class SerialPortManager
    {
        ...
        private SerialPortManager()
        {
            ...
            _PortList = new List<System.IO.Ports.SerialPort>(Math.Max(8, _PortCount + 1));          // 暂时支持最少 8 个端口
        ...
        public System.IO.Ports.SerialPort GetComPortInstance(string portName)
        {
            ...
            {                           // 一般不可能出现找不到设备的情况
                ...
                {
                    BaudRate = 9600,                     // 默认速率、数据位、停止位、校验位等参数
                    DataBits = 8,
